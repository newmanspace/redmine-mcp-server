...
class SubscriptionScheduler:
        ...
        try:
            ...
            for sub in all_subs:
                ...
                if report_type == "daily":
                    ...
                    if send_day_of_week:
                        should_send = (
                            send_day_of_week[:3].lower() == current_day_of_week.lower()
                        )
                    else:
    ...
    def _send_single_subscription(self, subscription: Dict[str, Any]):
        ...
        try:
            ...
            logger.error(f"Error sending subscription {
                    subscription.get('subscription_id')}: {e}")
    ...
    def get_job_status(self) -> Dict[str, Any]:
        ...
        return {"running": self.scheduler.running, "job_count": len(jobs), "jobs": jobs}
