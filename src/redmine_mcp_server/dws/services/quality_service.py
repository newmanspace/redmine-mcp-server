...
class DataQualityMonitor:
    ...
    def get_table_row_counts(self) -> Dict[str, int]:
        ...
        tables = [
            'ods_projects', 'ods_issues', 'ods_journals', 'ods_users',
            'dwd_issue_daily_snapshot', 'dws_project_daily_summary',
            'dws_issue_contributors', 'ads_project_health_report'
        ]
            ...
            try:
                ...
                if result and result['max_date']:
                    ...
                    freshness[table] = {
                        ...
                        "status": "OK" if age_hours < self.thresholds["max_data_age_hours"] else "STALE"
                    }
                else:
                    freshness[table] = {
                        "max_date": None,
            ...
            try:
                ...
                if result:
                    ...
                    completeness[f"{table}.{column}"] = {
                        ...
                        "status": "OK" if null_rate < self.thresholds["null_rate_threshold"] else "HIGH_NULL_RATE"
                    }
